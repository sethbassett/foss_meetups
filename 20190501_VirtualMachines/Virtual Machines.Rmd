...
![VirtualBox HDD](img/virtualbox_set_iso.png){height=450px}  
  ...
  ## Start your virtual machine  
    ...
    * Once the VM boots into Mint, use your windows key and type in "display" to change the size of the display  
...
Now boot up your new Linux VM. After booting, you can increase your screen size by going to the start menu and searching for 'display.' 
